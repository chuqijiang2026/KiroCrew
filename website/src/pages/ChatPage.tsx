          ...
          <div className="relative flex flex-col flex-1 min-h-0">
            ...
            <div className="relative">
              ...
              {/* One surface for both Continue buttons — the error card hosts one
                  ...
                  The title names the action, which is what distinguishes this notice
                  from the error card above it. Without it the two stack as equally-red
                  peers and read as "two things are wrong" rather than "this is the
                  answer to the button you just pressed" — a first-time reader then
              ...
              {continueError && (
                ...
                >
                  <ErrorNotice
                    title={i18nT('pages.chatPage.could_not_continue')}
