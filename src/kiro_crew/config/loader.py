    ...
    def load(cls) -> KiroCrewConfig:
        ...
        cfg = cls(
            ...
            feishu=FeishuConfig(
                ...
                allowed_open_ids=[
                    str(o) for o in feishu_data.get("allowed_open_ids", []) if o
                ],
                allow_group=bool(feishu_data.get("allow_group", False)),
                allowed_group_ids=[
                    str(g) for g in feishu_data.get("allowed_group_ids", []) if g
                ],
