...
_STRICT_INTERNAL_API_PATHS = frozenset(
    {
        ...
        "/api/mcp/servers",
        # Session control -- the four routes behind the session_create /
        # session_message_send / session_stop / session_read_message MCP tools.
        # STRICT, not mixed: no browser calls them, and they are the entry point
        # to opening, typing into, stopping, and reading ANOTHER live
        # conversation. A cookie fall-through there would be a new authorization
...
def _register_mcp_routes(app: web.Application) -> None:
    ...
    # serves the same MCP surface as the dashboard; all four are on
