...
def main(argv: list[str] | None = None) -> int:
    ...
    new_offenders = sorted(unformatted - baseline)
    ...
    print(
        f"black gate passed: {len(unformatted)} known-unformatted file(s) remain "
        "in the baseline, and every other file is clean."
    )
    return 0
